...
class EleAction extends CommonAction{
   ...
   public function loadcart(){
    ...
    public function index(){
		...
		$lists = D('Eleproduct')->where(array('is_tuijian'=>1, 'audit' => 1,'shop_id'=>array('in', $shop_ids),'cost_price' => array('neq','')))->order(array('sold_num' => 'desc','create_time' => 'desc'))->limit(0,6)->select();
    ...
    public function shop($shop_id = 0){
		...
		$this->assign('tuijian', $tuijian = $obj->where(array('shop_id' => $shop_id,'is_tuijian'=>1, 'audit' => 1, 'cost_price' => array('neq','')))->order(array('create_time' =>'desc'))->limit(0,2)->select());//推荐开始
